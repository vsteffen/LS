...
/*   Updated: 2016/05/07 20:56:23 by vsteffen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_ls.h"

void		partition_u(t_node_ptr head, t_node_ptr *front, t_node_ptr *back)
{
	t_node_ptr		fast;
	t_node_ptr		slow;
...
t_node_ptr	merge_list_u(t_node_ptr a, t_node_ptr b)
{
